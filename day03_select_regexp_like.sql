...
SELECT * FROM kelimeler;
 ...
 SELECT kelime
 FROM kelimeler
 WHERE REGEXP_LIKE (kelime,'ot|at'); -- Hic bir sey yazmasak da insensitive olarak calisir
...
-- case-sensitive'e dikkat etmeksizin listele
	...
	-- Q6 : h ile baslayip t ile biten 2. karakteri sadece rakam olan 3 harfli kelimeleri 
	-- (h ile t kucuk harfli olanlari) listeleyiniz
	...
	-- Q7 : h ile baslayip t ile biten 2. karakteri buyuk harf olan 3 harfli kelimeleri 
	-- (h ile t kucuk harfli olanlari) listeleyiniz
