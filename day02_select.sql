...
FROM meslek_lisesi
WHERE 70<derece && derece<80; -- 70<derece<80 seklinde kabul etmez
...
FROM meslek_lisesi
WHERE derece
BETWEEN 71 AND 79; -- between komutu sinirlari dahil eder ve kucukten buyuge dogru baktigi icin once kucuk deger yazilmalidir !!!
...
/*-------------------------------------------------------------------------
Q11: Ismi Ismi Ahmet ile Ayse Cano arasinda olan personel bilgilerini listeleyin
---------------------------------------------------------------------------*/
...
/*-------------------------------------------------------------------------
Q13: Id'si 10001, 10005 ya da 10008 olan personel isimlerini listeleyin / SELECT-IN ile cozun
---------------------------------------------------------------------------*/
...
SELECT *
FROM personel -- persnel tablosudan
